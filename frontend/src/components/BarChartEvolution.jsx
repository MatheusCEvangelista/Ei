...
export default function BarChartEvolution({ data }) {
  if (!data?.length) return <div style={{height:200,display:'flex',alignItems:'center',justifyContent:'center',color:'var(--text3)',fontSize:13}}>Sem dados ainda</div>;
  return (
    <ResponsiveContainer width="100%" height={200}>
      <BarChart data={data} barCategoryGap="35%">
        ...
        <Legend formatter={v=><span style={{fontSize:12,color:'var(--text2)',fontFamily:'var(--font)'}}>{v==='income'?'Receita':'Despesa'}</span>} iconType="circle" iconSize={7}/>
